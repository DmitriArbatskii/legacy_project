...
function fullInTopics() {
    ...
    var fullInSubject2 = new Subject('fullInSubject', ['Наследование', 'Полиморфизм', 'Заключение'], 3, 5);
...
function shortAnswerTopics() {
    var shortAnswerSubject = new Subject('shortAnswerSubject',
        ['Модель-это упрощение и абстракция реального мира,а модель-форма выражения изучаемой системы, процесса, вещи или понятия.Это может быть физическая сущность;это может быть какой-то график; или это может быть математическое выражение.'],
        1, 20);
